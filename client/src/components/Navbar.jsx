...
const navigate = useNavigate();
  const handleClick = () => {
    ...
    if (collapseMenuRef.current) {
      collapseMenuRef.current.style.display = isMenuOpen ? 'none' : 'block';
    }
  };
  ...
  <section
    ...
    <a href="" className="max-sm:w-full max-sm:mb-3 shrink-0"><img
        src="https://avatars.githubusercontent.com/u/144054938?v=4" alt="logo" className=' w-11 h-10' />
    </a>
        ...
        <ul className='flex items-center'>
          ...
          <li className='max-lg:py-2 px-3 cursor-pointer'>
            <span className="relative">
              ...
              <span
                className="absolute left-auto -ml-1 -top-1 rounded-full bg-red-500 px-1 py-0 text-xs text-white">{cartQuantity}</span>
            </span>
          </li>
          </Link>
